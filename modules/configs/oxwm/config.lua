...
local bar_font = "Iosevka Nerd Font Mono,Iosevka NFM:style=Bold:size=13"
...
oxwm.autostart("vicinae server --replace")
oxwm.autostart("picom")
oxwm.autostart("feh --bg-scale ~/nix-config/modules/themes/gruvbox-material/wallpaper.png")
oxwm.autostart("dunst")
oxwm.autostart("nm-applet")
oxwm.autostart("xclip")
